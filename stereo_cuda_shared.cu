...
//
//__device__
//void loadMeanStdShared(Float3 buf[][WIDE_PATCH_W], int rCenter, int cCenter, Float3 &mean, Float3 &invStd) {
//    Float3 sum;
//    resetValue(sum, 0.0);
//    int cnt = 0;
...
//    loadMeanStdShared(buf1, r, c1, mean1, invStd1);
//    loadMeanStdShared(buf2, r, c2, mean2, invStd2);
